            ...
            <div id="package-documentation">
              <div id="package-heading">
                ...
                <p class="mt-5 text-gray-900">
                  Create and register bot commands created using
                  <span class="font-bold">tcli --create:command [name]</span>.
                </p>
              </div>
      ...
      DONE
              ...
              <div class="mt-10" id="nodejs-usage">
                ...
                <p class="mt-2 text-black">
                  ...
                  open <spam class="font-bold">registerCommands.js</spam> and
