  ...
  <div class="mb-10">
    ...
    <div class="text-gray-900 max-w-screen-xl mx-auto px-4 leading-6">
      ...
      <div class="flex text-black">
        ...
        <h1 class="text-xl font-bold underline mt-4">Products</h1>
      </div>
      <!-- Breadcrumb -->
          ...
          <div class="-mx-4 flex flex-wrap">
              ...
              >
                <div class="flex-1">
                  <a href="/" class="text-lg font-bold leading-7 text-black"
                    >BuyAndSell, a Modern Logistics-Based Solution For Tertiary
                    Institution</a
                  >
            ...
            <div class="w-full flex flex-col p-4 sm:w-1/2 lg:w-1/3">
              ...
              >
                <div class="flex-1">
                  <a href="/" class="text-lg font-bold leading-7 text-black"
                    >iGoTell, a Modern Reporting Solution For Africa</a
                  >
                  <p class="mt-2 text-gray-700">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    Minima commodi rem nesciunt quo minus aperiam pariatur
            ...
            <div class="w-full flex flex-col p-4 sm:w-1/2 lg:w-1/3">
              ...
              >
                <div class="flex-1">
                  <a href="/" class="text-lg font-bold leading-7 text-black"
                    >Kolobo, a Modern Freelancing Platform For Hiring Fashion
                    Designers in Africa</a
                  >
                  <p class="mt-2 text-gray-700">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    Minima commodi rem nesciunt quo minus aperiam pariatur
    ...
    <!-- <div class="mt-5 mb-10 max-w-screen-xl mx-auto px-4 text-purple-800">
        <div class="flex flex-wrap w-full mx-auto items-center justify-center">
          <div
            class="w-1/8 p-3 border border-gray-400 rounded-l inline-flex items-center justify-center cursor-pointer hover:bg-gray-300"
          >
            Prev
          </div>
          <div
            class="w-1/8 p-3 border border-gray-400 inline-flex items-center justify-center cursor-pointer hover:bg-gray-300"
          >
            1
          </div>
          <div
          ...
          <div
            class="w-1/8 p-3 border border-gray-400 rounded-r inline-flex items-center justify-center cursor-pointer hover:bg-gray-300"
          >
            Next
          </div>
        </div>
    ...
    <!-- Not yet -->
    <div class="mt-10 max-w-screen-xl mx-auto px-4 text-gray-800">
      <svg
        class="w-80 h-56 md:h-64 mx-auto items-center justify-center"
      ...
      >
        ...
        <ellipse
          ...
          opacity="0.1"
        />
        <ellipse cx="833.1" cy="723.1" rx="40.21" ry="6.8" fill="#553c9a" />
        <path
      ...
      <div class="mt-5 text-xl md:text-3xl text-center">
        No product(s) at the moment.
      </div>
    </div>
  </div>
</template>
...
export default {
  head: {
    title: 'Obafunso Ridwan A. - Products',
